...
impl LanguageServer for Slang {
    ...
    const DOWNLOAD_TAG: &'static str = "v0.1.5";
    ...
    fn asset_name(
        ...
        Ok(match (os, arch) {
            (zed::Os::Mac, zed::Architecture::Aarch64) => "slang-server-macos.tar.gz",
            ...
            (zed::Os::Linux, zed::Architecture::X8664) => "slang-server-rockylinux-x64.tar.gz",
